      ...
      <CardContent className="h-[280px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} layout="vertical">
            ...
            <XAxis type="number" stroke="hsl(220, 15%, 55%)" fontSize={11} fontFamily="JetBrains Mono" tickFormatter={(v) => fmtCostShort(v)} />
            ...
            <Tooltip
              ...
              formatter={(value: number, name: string) => [name === "cost" ? fmtCost(value, 6) : fmtNum(value), name === "cost" ? "Náklady" : "Požadavky"]}
            />
